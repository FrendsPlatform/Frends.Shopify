...
using Frends.Shopify.GetCustomer.Helpers;
...
/// <summary>
/// Test cases for Shopify GetCustomer task.
/// </summary>
[TestFixture]
public class UnitTests
{
    ...
    [Test]
    public async Task GetCustomer_SuccessTest()
    {
    ...
    [Test]
    public async Task GetCustomer_WithFields_SuccessTest()
    {
    ...
    [Test]
    public void GetCustomer_ShopNameValidationFailureTest()
    {
    ...
    [Test]
    public void GetCustomer_AccessTokenValidationFailureTest()
    {
        var invalidConnection = new Connection
        {
            ShopName = shopName,
    ...
    [Test]
    public void GetCustomer_ApiVersionValidationFailureTest()
    {
        var invalidConnection = new Connection
        {
            ShopName = shopName,
    ...
    [Test]
    public void GetCustomer_CustomerIdValidationFailureTest()
    {
    ...
    [Test]
    public async Task GetCustomer_ErrorHandlingTest()
    {
    ...
    [Test]
    public void GetCustomer_Handle_WhenThrowErrorIsTrue_ThrowsException()
    {
    ...
    [Test]
    public void GetCustomer_Handle_WhenThrowErrorIsFalse_ReturnsErrorResult()
    {
        var ex = new Exception("Test exception");
        const string customMessage = "Custom error context";
