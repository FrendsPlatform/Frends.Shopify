...
internal class ShopifyApiClient : IShopifyApiClient, IDisposable
{
    ...
    public async Task<CustomersResponse> GetCustomersAsync(string createdAtMin, string createdAtMax, string state, string fields, int limit, string pageInfo, CancellationToken cancellationToken)
    {
        ...
        var url = $"customers.json{queryString}";
        ...
        {
            Customers = (JArray)json["customers"],
