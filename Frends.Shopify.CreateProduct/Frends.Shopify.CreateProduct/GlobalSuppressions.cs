...
[assembly: SuppressMessage("StyleCop.CSharp.OrderingRules", "SA1201:Elements should appear in the correct order", Justification = "Not impacting functionality", Scope = "member", Target = "~M:Frends.Shopify.CreateProduct.Shopify.CreateProduct(Frends.Shopify.CreateProduct.Definitions.Input,Frends.Shopify.CreateProduct.Definitions.Connection,Frends.Shopify.CreateProduct.Definitions.Options,System.Threading.CancellationToken)~System.Threading.Tasks.Task{Frends.Shopify.CreateProduct.Definitions.Result}")]
